...
export function SwitcherSetterManageIcon(props: any) {
    ...
    return <img src={setterType === 'switcherManage' ? Selected : Unselected} style={{display: 'block'}} onMouseDown={displaySetter}/>
}